...
class Palette(object):
    ...
    # Color
    COLOR_BACKGROUND_LIGHT = '#333842'
    COLOR_BACKGROUND_NORMAL = '#282C34'
    COLOR_BACKGROUND_DARK = '#21252B'

    COLOR_SEPARATOR_LIGHT = '#4B5261'
    COLOR_SEPARATOR_DARK = '#0F1012'

    COLOR_PRIMARY_LIGHT = '#007AFF'
    COLOR_PRIMARY_NORMAL = '#457AE5'
    COLOR_PRIMARY_DARK = '#2354B3'

    COLOR_TAG_ONLINE = '#00FFA2'
    COLOR_TAG_OFFLINE = '#72879D'
    COLOR_TAG_WARNING = '#F24958'
    COLOR_TAG_SUCCESS = '#00FFA2'

    COLOR_BUTTON_SUCCESS = '#00FFA2'
    COLOR_BUTTON_WARNING = '#F24958'

    COLOR_LABEL_LINK = '#29FFB3'

    # Gradient
    COLOR_GRADIENT_PRIMARY = '#7AEFFF'
