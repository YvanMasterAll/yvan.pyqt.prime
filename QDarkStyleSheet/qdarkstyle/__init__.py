...
def load_stylesheet(*args, **kwargs):
    """
    Load the stylesheet. Takes care of importing the skin module.

    Args:
        pyside (bool): True to load the PySide (or PySide2) skin file,
                       False to load the PyQt4 (or PyQt5) skin file.
                       Default is False.
        or
