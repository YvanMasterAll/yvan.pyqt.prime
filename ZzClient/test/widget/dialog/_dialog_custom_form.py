...
# Form implementation generated from reading ui file '_dialog_custom_form.ui'
#
...
class Ui_Dialog_Custom_Form(object):
    def setupUi(self, Dialog_Custom_Form):
        Dialog_Custom_Form.setObjectName("Dialog_Custom_Form")
        Dialog_Custom_Form.resize(606, 449)
        Dialog_Custom_Form.setStyleSheet("")
        self.gridLayout = QtWidgets.QGridLayout(Dialog_Custom_Form)
        self.gridLayout.setObjectName("gridLayout")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.widget = QtWidgets.QWidget(Dialog_Custom_Form)
        ...
        self.retranslateUi(Dialog_Custom_Form)
        QtCore.QMetaObject.connectSlotsByName(Dialog_Custom_Form)

    def retranslateUi(self, Dialog_Custom_Form):
        _translate = QtCore.QCoreApplication.translate
        Dialog_Custom_Form.setWindowTitle(_translate("Dialog_Custom_Form", "Form"))
        self.label.setText(_translate("Dialog_Custom_Form", "设备名称"))
        self.input_device_name.setPlaceholderText(_translate("Dialog_Custom_Form", "输入设备名称"))
        self.label_4.setText(_translate("Dialog_Custom_Form", "维护日期"))
        self.label_3.setText(_translate("Dialog_Custom_Form", "设备状态"))
        self.radio_state_on.setText(_translate("Dialog_Custom_Form", "激活"))
        self.radio_state_off.setText(_translate("Dialog_Custom_Form", "禁用"))
        self.input_company_name.setPlaceholderText(_translate("Dialog_Custom_Form", "输入公司名称"))
        self.label_5.setText(_translate("Dialog_Custom_Form", "负责人"))
        self.label_2.setText(_translate("Dialog_Custom_Form", "公司名称"))
