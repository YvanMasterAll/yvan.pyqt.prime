...
class NavBar(BaseView, Bloc_Navbar):
    ...
    def navbutton_factory(self, nav):
        ...
        navbutton.setIconNormal(self.resource.render_pixmap(nav['icon']))
        navbutton.setIconCheck(self.resource.render_pixmap(nav['icon']))
        navbutton.setIconHover(self.resource.render_pixmap(nav['icon']))
