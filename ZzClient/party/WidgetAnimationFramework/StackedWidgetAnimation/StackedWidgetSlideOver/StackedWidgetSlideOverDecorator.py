...
class StackedWidgetSlideOverDecorator(QWidget):
    m_widgetForGrab:QWidget
    m_foreground:QPixmap

    def __init__(self, *args, _widgetForGrab, **kwargs):
        super(StackedWidgetSlideOverDecorator, self).__init__(*args, **kwargs)
    ...
    def paintEvent(self, _event):
        ...
        super(StackedWidgetSlideOverDecorator, self).paintEvent(_event)