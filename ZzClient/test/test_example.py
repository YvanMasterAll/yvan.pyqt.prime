...
def test_window_title(window):
    """Check that the home title shows as declared."""
    assert window.windowTitle() == 'ZzClient'


def test_window_geometry(window):
    """Check that the home width and height are set as declared."""
